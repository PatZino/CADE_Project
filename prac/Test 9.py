    ...
    def differential_evolution(func, initial_de_population, mutation_factor,
        ...
        for i in range(max_gen):
            for j in range(population_size):
                ...
                trial_vector = np.where(crossover, mutant_vector, pop[j])
                # print("trial vector:\n", trial_vector)
                ...
                # print(i, j, ":population \n", initial_de_population[i])
                if (max_gen-2):
                    bah = best
            mutation_factor = np.random.standard_cauchy(1)
            # print("mutation factor: ", mutation_factor)
...
# ---------------------------------------------------------------------------------------------
    ...
    updated_cade_pop = np.concatenate((best_DE_pop, CA_pop), axis=0)
...
# ----------------------- loop in the cade algorithm -------------------------------------------
    ...
    while number_of_runs < 50:
        ...
        fitness_del = np.asarray([func(ind) for ind in best_DE_pop])
        ...
        for j in range(len(best_DE_pop)):
        ...
        updated_cade_pop = np.concatenate((CA_pop, best_DE_pop), axis=0)  # new cade population
